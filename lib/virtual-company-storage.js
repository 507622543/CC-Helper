...
export function createAgent(workspaceId, { role, roleKey, model, parentId, systemPrompt, responsibilities, canDelegate, canApprove, apiProfileId }) {
    const id = randomUUID();
    ...
    cache.agents[id] = {
        ...
        apiProfileId: apiProfileId || null, // Per-agent API configuration
        status: 'idle',
        llmHistory: [],
        createdAt: new Date().toISOString(),
    };
